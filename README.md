...
below iOS 16 or macOS 13, or outside App Store distribution), the SDK baselines
the installation without emitting `firstOpen` rather than counting it incorrectly.
